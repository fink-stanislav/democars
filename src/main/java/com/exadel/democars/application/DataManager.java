...
public class DataManager {
    public static Car[] getCarList() {
        Car[] cars = new Car[]{
                ...
                new Car("Nissan", "Scorpio", 20100f, 17235, "YTDEWWDF54EWR77RER", Car.Condition.New),
                new Car("Ford", "Mustang GT", 2125f, 83509, "BNDKLEL45477FEED", Car.Condition.New),
                new Car("Ford", "Mustang Pace Car", 15900f, 25473, "UIPSKFSASDAEFEE5452", Car.Condition.Used),
                new Car("Volvo", "XC90T6", 10000f, 80821, "985FDCCVEWQDFQ1124", Car.Condition.Used),
                new Car("BMW", "7-Series 750 Li", 16400f, 80994, "NMNFDLJEWIEF5564", Car.Condition.Used),
                new Car("Ford", "Mustang GT 500", 48100f, 1, "JLJKDFF9SAFDA85FFD5", Car.Condition.New),
